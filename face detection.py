...
cv2.rectangle(joshik, (faceLocation_joshik[3], faceLocation_joshik[0]),
              (faceLocation_joshik[1], faceLocation_joshik[2]), (255, 0, 255), 3)

faceLocation_joshiktest = face_rec.face_locations(joshik_test)[0]
encode_joshiktest = face_rec.face_encodings(joshik_test)[0]
cv2.rectangle(joshik_test, (faceLocation_joshik[3], faceLocation_joshik[0]),
              (faceLocation_joshik[1], faceLocation_joshik[2]), (255, 0, 255), 3)
